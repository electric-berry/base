...
def get_data(target):
    ...
    download = requests.get(f'https://storage.googleapis.com/dft-statistics/road-traffic/downloads/aadf/local_authority_id/dft_aadf_local_authority_id_{end.group()}.csv')
